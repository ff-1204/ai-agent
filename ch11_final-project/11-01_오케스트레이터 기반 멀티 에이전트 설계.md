...
>
> **`credentials.json`과 `token.json`은 절대 커밋하지 마세요**([4.3절](../ch04_dev-env/04-03_%ED%99%98%EA%B2%BD%EB%B3%80%EC%88%98%20%EC%84%A4%EC%A0%95%ED%95%98%EA%B8%B0.md)). `.gitignore`에 들어 있는지 확인하세요.
