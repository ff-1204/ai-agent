...
> **여기까지** — 가장 큰 에이전트(RAG)를 봤습니다([11.3절](11-03_%EB%AC%B8%EC%84%9C%20%EC%A0%80%EC%9E%A5%C2%B7%EA%B2%80%EC%83%89%20%EC%97%90%EC%9D%B4%EC%A0%84%ED%8A%B8.md)).
> **이 절의 질문** — 이번엔 **가장 작은 것**입니다. 왜 이렇게 작을까?
> **다 읽으면** — **MCP를 쓰면 코드가 얼마나 줄어드는지**, 그리고 **대신 무엇을 감수하는지** 알게 됩니다.
...
**일하는 에이전트 셋이 다 모였습니다.** 파일 · 문서 · 웹.

그런데 셋은 서로를 모릅니다. 각자 자기 포트에서 자기 일만 합니다. **누가 "이 일은 네가 해"라고 말해 주죠?** → **[11.5절](11-05_%EC%98%A4%EC%BC%80%EC%8A%A4%ED%8A%B8%EB%A0%88%EC%9D%B4%ED%84%B0%20%EC%97%90%EC%9D%B4%EC%A0%84%ED%8A%B8.md)**
