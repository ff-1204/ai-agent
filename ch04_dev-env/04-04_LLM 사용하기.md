...
> **공식 문서** — [OpenAI · Quickstart](https://platform.openai.com/docs/quickstart) · [LangChain · Models](https://docs.langchain.com/oss/python/langchain/models)
...
가장 밑바닥은 OpenAI가 제공하는 SDK를 직접 쓰는 것입니다. [4.3절](04-03_%ED%99%98%EA%B2%BD%EB%B3%80%EC%88%98%20%EC%84%A4%EC%A0%95%ED%95%98%EA%B8%B0.md)에서 넣어 둔 `OPENAI_API_KEY`를 자동으로 읽습니다.
...
> **쓸 수 있는 모델 이름과 가격은 [OpenAI 모델 문서](https://platform.openai.com/docs/models)에서 확인하세요.** 모델은 자주 추가되고 이름이 바뀌므로 여기 적어 두면 금방 낡습니다.
