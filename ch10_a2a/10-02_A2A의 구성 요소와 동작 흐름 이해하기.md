...
> **여기까지** — A2A가 **에이전트끼리(수평)** 잇는다는 것까지 왔습니다([10.1절](10-01_A2A%EB%9E%80.md)).
> **이 절의 질문** — **무엇이 오가지?** 그리고 왜 일반 API로는 부족하지?
> **다 읽으면** — 10.3~10.4에 나오는 **클래스 이름들이 미리 정리**됩니다. 여기를 건너뛰면 코드가 낯설게 느껴집니다.
...
이름은 다 나왔습니다. **AgentCard · Task · Message · Artifact.**

이제 **가장 단순한 것부터** 만들어 봅시다. LLM도 도구도 없이 **배관만** 있는 에이전트입니다. → **[10.3절](10-03_A2A%EC%9D%98%20%EA%B8%B0%EB%B3%B8%20%EC%82%AC%EC%9A%A9%EB%B2%95%20%EC%9D%B4%ED%95%B4%ED%95%98%EA%B8%B0.md)**
